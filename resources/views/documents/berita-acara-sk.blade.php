...
<body>
    <div class="header">
        ...
        <div class="company-name">
            PT Perusahaan Gas Negara Tbk.<br>
    ...
    <div class="date-section">
        ...
        Bulan <span class="underline">{{ app(App\Services\BeritaAcaraService::class)->getIndonesianMonthName($date) }}</span>
    ...
    <div class="notes">
        ...
        kebutuhan Sambungan Kompor dengan Peralatan Gas sebelum pemasangan Gas diuraikan sesuai dengan ketentuan PGN. Selanjutnya, pemeliharaan peralatan gas dan pipa instalasi menjadi tanggung jawab Pelanggan.<br><br>

        <strong>Demikian Berita Acara ini dibuat dengan sebenar-benarnya dan untuk digunakan sebagaimana mestinya.</strong>
    </div>
    ...
    <div class="footer-notes">
        ...
        <ol>
            ...
            <li>Apabila kebutuhan pipa kompor melebihi 15 meter, kelebihan akan dikenakan biaya sesuai PGN No. RTR 15.000/Unit. Tagihan akan dikirimkan kemudian melalui tim PGN Rp.69.000/meter*</li>
            ...
            <li>Pelanggan/Calon Pelanggan agar mendeklarasikan (menginformasikan) total seluruh atas saran acara yang terlaksana koneksi telah selesai/diselesaikan melalui berbagai sarana yang tersedia (ATM, SMS/Internet/Mobile Banking, Alfamart, GoDay, Tokopedia, LinkAja dan lain-lain).</li>
        </ol>
    </div>
</body>
</html>