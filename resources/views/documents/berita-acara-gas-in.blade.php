...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Background keseluruhan diubah menjadi putih */
            position: relative;
            min-height: 100vh;
        }
        ...
        .header-logo {
            text-align: right;
            margin-bottom: 20px;
            /* Spasi antara logo dan judul ditambah lagi */
            margin-top: -8px;
            padding-right: 0;
        }
...
<body>
    ...
    <div class="date-info">
        ...
        <table style="width: 100%; border: 0; margin: 0; padding: 0; border-collapse: collapse;">
            <tr>
                <td
                    style="border: 0; padding: 0; margin: 0; width: auto; vertical-align: baseline; white-space: nowrap;">
                    Pada hari ini</td>
                <td
                    style="border: 0; border-bottom: 1px solid white; padding: 0 5px 2px 0; margin: 0; width: 250px; vertical-align: baseline;">
                </td>
                <td style="border: 0; padding: 0; margin: 0; width: auto; vertical-align: baseline;">, telah dilakukan
                    penyalaan Gas pertama kali ("Tanggal Dimulai")</td>
            </tr>
        </table>
        kepada
    </div>
    ...
    <table class="info-table" style="font-size: 8pt;">
        <tr>
            ...
            <td class="info-value"
                style="width: 35%; font-size: 8pt; padding-bottom: 8px !important; border-bottom: 0 !important;">: Meter
                konvensional / Smart Meter</td>
        ...
        <tr>
            ...
            <td style="padding: 8.5px 0 2px 0; vertical-align: top; font-size: 8pt; width: 35%;">
                <table style="width: 67%; border: 0; border-collapse: collapse; margin: 0;" cellpadding="0"
                    cellspacing="0">
                    <tr>
                        <td
                            style="border-bottom: 1px solid #333; padding-bottom: 8px; padding-top: 0; font-size: 8pt; padding-left: 0; border-top: 0; border-left: 0; border-right: 0; line-height: 1;">
                            :</td>
                        <td
                            style="text-align: center; border-bottom: 1px solid #333; padding-bottom: 8px; padding-top: 0; font-size: 8pt; padding-left: 0; border-top: 0; border-left: 0; border-right: 0; line-height: 1;">
                            0,016 / 2,5</td>
                        <td
                            style="text-align: right; width: 45px; font-size: 8pt; border: 0; padding: 0; padding-right: 0; padding-top: 0 !important; line-height: 1;">
                            m3/jam</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td style="padding: 8.5px 0 2px 0; vertical-align: top; font-size: 8pt; width: 35%;">
                <table style="width: 76%; border: 0; border-collapse: collapse; margin: 0;" cellpadding="0"
                    cellspacing="0">
                    <tr>
                        <td
                            style="border-bottom: 1px solid #333; padding-bottom: 8px; padding-top: 0; font-size: 8pt; padding-left: 0; border-top: 0; border-left: 0; border-right: 0; line-height: 1;">
                        ...
                        <td
                            style="text-align: right; width: 45px; font-size: 8pt; border: 0; padding: 0; padding-right: 0; padding-top: 2px !important; line-height: 1; padding-left: 10px !important;">
                            (MM/YYYY)</td>
                    </tr>
                </table>
            </td>
            ...
            <td style="padding: 8.5px 0 2px 0; vertical-align: top; font-size: 8pt;" colspan="3">
                <table style="width: 100%; border: 0; border-collapse: collapse; margin: 0;" cellpadding="0"
                    cellspacing="0">
                    <tr>
                        <td
                            style="border-bottom: 1px solid #333; padding-bottom: 8px; padding-top: 0; font-size: 8pt; padding-left: 0; padding-right: 5px; border-top: 0; border-left: 0; border-right: 0; line-height: 1; width: 45px;">
                            : </td>
                        <td
                            style="text-align: right; width: 25px; font-size: 8pt; border: 0; padding: 0; padding-right: 0; padding-top: 2px; line-height: 1;">
                            Bar</td>
                        <td style="font-size: 8pt; padding: 0 0 0 10px; width: 40px;">Suhu</td>
                        <td
                            style="border-bottom: 1px solid #333; padding-top: 1.5px !important; font-size: 8pt; padding-left: 0; padding-right: 2px; border-top: 0; border-left: 0; border-right: 0; line-height: 1; width: 45px;">
                            : </td>
                        <td
                            style="text-align: right; width: 18px; font-size: 8pt; border: 0; padding: 0; padding-right: 0; padding-top: 2px; line-height: 1;">
                            °C</td>
                        <td
                            style="text-align: left; font-size: 8pt; border: 0; padding: 0; padding-right: 0; padding-top: 2px; line-height: 1; padding-left: 3px;">
                            (jika ada)</td>
                    </tr>
                </table>
            </td>
    ...
    <div class="responsibility-text">
        Dengan dilakukannya Gas In ini, maka Pelanggan menyetujui untuk bertanggung jawab atas pengoperasian dan
        perawatan
    </div>
