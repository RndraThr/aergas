...
@section('content')
  ...
  <div class="space-y-6" x-data="gasInCreate()" x-init="init()">
    ...
    <div class="flex items-center justify-between">
      ...
      <a href="javascript:void(0)" onclick="goBackWithPagination('{{ route('gas-in.index') }}')"
    ...
    <form class="bg-white rounded-xl card-shadow p-6 space-y-8" @submit.prevent="onSubmit">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-red-700 text-sm mt-1">Customer ini memiliki status "batal" dan tidak dapat melanjutkan
                      ke modul Gas In. Silakan hubungi admin untuk informasi lebih lanjut.</p>
                  </div>
                </div>
              </div>
            </template>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Gas In <span
      ...
      <div class="flex justify-end gap-3 pt-2">
        ...
        <button type="submit"
          :disabled="submitting || !customer || !reff || !tanggal || (customer && customer.status === 'batal')"
      ...
      return {
        ...
        async onSubmit() {
          ...
          if (this.customer && this.customer.status === 'batal') {
            alert('Customer dengan status "batal" tidak dapat melanjutkan ke modul Gas In.');
            return;
          }
