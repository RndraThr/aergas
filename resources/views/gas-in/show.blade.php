    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        @if($gasIn->canEdit() || in_array($gasIn->module_status, ['draft', 'ai_validation', 'tracer_review', 'rejected']) && auth()->user()->hasAnyRole(['admin', 'super_admin', 'gas_in', 'tracer']))
          <a href="{{ route('gas-in.edit', $gasIn->id) }}"
        ...
        <div class="space-y-1">
          ...
          @if($gasIn->createdBy)
            <div class="flex items-center">
              <div
                class="w-8 h-8 bg-gradient-to-br from-orange-500 to-amber-600 rounded-lg flex items-center justify-center mr-3 shadow">
        ...
        <div class="mt-6 pt-6 border-t border-orange-200">
          <div class="flex items-center gap-4 flex-wrap">
            ...
            @if($gasIn->ai_overall_status)
              <div class="flex items-center">
                <div
                  class="w-3 h-3 rounded-full mr-2 {{ $gasIn->ai_overall_status === 'ready' ? 'bg-green-500' : 'bg-yellow-500' }}">
                </div>
          ...
          <div class="space-y-1">
            ...
            <div class="font-medium text-gray-700">
              @if($gasIn->calonPelanggan->no_telepon)
                <a href="tel:{{ $gasIn->calonPelanggan->no_telepon }}"
          ...
          <div class="space-y-1">
            ...
            <div class="font-medium text-gray-700">
              @if($gasIn->calonPelanggan->email)
                <a href="mailto:{{ $gasIn->calonPelanggan->email }}"
                  class="text-orange-600 hover:text-orange-800 transition-colors">
