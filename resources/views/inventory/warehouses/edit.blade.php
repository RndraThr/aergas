...
@section('title', 'Edit Warehouse - AERGAS')
...
<div class="space-y-6">
    ...
    <!-- Form -->
    <form action="{{ route('inventory.warehouses.update', $warehouse) }}" method="POST" class="bg-white rounded-xl card-shadow p-6 space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="warehouse_type" required
                        ...
                        <option value="pusat" {{ old('warehouse_type', $warehouse->warehouse_type) == 'pusat' ? 'selected' : '' }}>Gudang Pusat</option>
                        <option value="cabang" {{ old('warehouse_type', $warehouse->warehouse_type) == 'cabang' ? 'selected' : '' }}>Gudang Cabang</option>
                        <option value="proyek" {{ old('warehouse_type', $warehouse->warehouse_type) == 'proyek' ? 'selected' : '' }}>Gudang Proyek</option>
                    </select>
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <textarea name="address" rows="3"
                              ...
                              class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $warehouse->address) }}</textarea>
                    @error('address')
                        <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="province" value="{{ old('province', $warehouse->province) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="latitude" value="{{ old('latitude', $warehouse->latitude) }}"
                               step="0.00000001"
                    ...
                    <div>
                        ...
                        <input type="number" name="longitude" value="{{ old('longitude', $warehouse->longitude) }}"
                               step="0.00000001"
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="email" name="pic_email" value="{{ old('pic_email', $warehouse->pic_email) }}"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          ...
                          class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $warehouse->description) }}</textarea>
                @error('description')
                    <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                @enderror
            </div>
