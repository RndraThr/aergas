...
@section('title', 'Edit Item - AERGAS')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="unit" id="unit" required
                            ...
                            <option value="roll" {{ old('unit', $item->unit) == 'roll' ? 'selected' : '' }}>Roll (roll)</option>
                            <option value="set" {{ old('unit', $item->unit) == 'set' ? 'selected' : '' }}>Set (set)</option>
                        </select>
                        @error('unit')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="minimum_stock" id="minimum_stock" value="{{ old('minimum_stock', $item->minimum_stock) }}" min="0" step="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="reorder_point" id="reorder_point" value="{{ old('reorder_point', $item->reorder_point) }}" min="0" step="1"
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="last_unit_price" id="last_unit_price" value="{{ old('last_unit_price', $item->last_unit_price) }}" min="0" step="0.01"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="specification" id="specification" rows="4"
                                  ...
                                  placeholder='{"diameter": "1 inch", "material": "PVC", "color": "gray"}'>{{ old('specification', $item->specification) }}</textarea>
                        @error('specification')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
