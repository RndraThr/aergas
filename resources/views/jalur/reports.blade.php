    ...
    <div class="mb-6">
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-8">
                ...
                <button onclick="showReport('variance')" 
                        id="tab-variance"
                        class="report-tab py-2 px-1 border-b-2 font-medium text-sm border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                    Variance Analysis
                </button>
                <button onclick="showReport('comprehensive')" 
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Estimasi (m)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Penggelaran (m)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actual MC-100 (m)</th>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Progress</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Lowering Entries</th>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Estimasi (m)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actual MC-100 (m)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Variance (m)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Variance (%)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status</th>
                        </tr>
                    </thead>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <button onclick="exportComprehensiveReport()" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                        📊 Export Excel
                    </button>
                    <button onclick="printComprehensiveReport()" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                        🖨️ Print
                    </button>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <!-- Basic Info -->
                            <th rowspan="2" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase border-r">Line Number</th>
                            <th rowspan="2" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase border-r">Cluster</th>
                            <th rowspan="2" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase border-r">Diameter</th>
                            <th rowspan="2" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase border-r">Jalan</th>
                            
                            <!-- Planning -->
                            <th colspan="2" class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase border-r bg-blue-50">Perencanaan</th>
                            
                            <!-- Lowering Data -->
                            <th colspan="4" class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase border-r bg-green-50">Data Lowering</th>
                            
                            <!-- Joint Data -->
                            <th colspan="3" class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase border-r bg-orange-50">Data Joint</th>
                            
                            <!-- Calculations -->
                            <th colspan="4" class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-purple-50">Perhitungan</th>
                        </tr>
                        <tr>
                            <!-- Planning sub-headers -->
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r">Estimasi (m)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r">Status</th>
                            
                            <!-- Lowering sub-headers -->
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Entries</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Penggelaran (m)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">MC-100 (m)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase border-r">Last Update</th>
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Variance (m)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Variance (%)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Progress (%)</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Overall Status</th>
                        </tr>
                    </thead>
