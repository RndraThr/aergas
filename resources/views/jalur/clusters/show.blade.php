    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-gray-600">{{ $cluster->code_cluster }} - {{ $cluster->lineNumbers->count() }} Line Numbers</p>
            </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Line Number</th>
                                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Diameter</th>
                                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Estimasi</th>
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @foreach($cluster->lineNumbers->sortBy('line_number') as $lineNumber)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-900">{{ number_format($lineNumber->estimasi_panjang, 1) }}m</td>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-lg font-semibold text-blue-600">{{ $cluster->lineNumbers->count() }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2">
                                ...
                                @if($stats['total_actual'] > 0)
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-medium {{ $stats['total_variance'] >= 0 ? 'text-red-600' : 'text-green-600' }}">
