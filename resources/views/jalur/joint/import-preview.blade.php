                        ...
                        <tr class="hover:bg-green-50">
                            ...
                            <td class="px-4 py-2">
                                @if(!empty($item['data']['foto_hyperlink']))
                                    <a href="{{ $item['data']['foto_hyperlink'] }}" target="_blank"
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="px-4 py-2 text-xs">
                                @if(!empty($item['data']['foto_hyperlink']))
                                    <a href="{{ $item['data']['foto_hyperlink'] }}" target="_blank"
                                       class="inline-flex items-center gap-1 {{ ($item['photo_changed'] ?? false) ? 'text-blue-600' : 'text-gray-400' }} underline hover:opacity-80">
                                        {{ ($item['photo_changed'] ?? false) ? '✓ diupdate' : 'ada' }}
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                                    </a>
                                @else
