...
@section('content')
    <div class="w-full px-0 py-8 space-y-8">
        ...
        <div class="px-6 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
                    ...
                    <div
                        class="space-y-1 text-xs opacity-80 max-h-24 overflow-y-auto scrollbar-thin scrollbar-thumb-white/30 scrollbar-track-white/10">
                        @php
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 rounded-lg flex items-center justify-center 
                                            @if($diameter == '63') bg-blue-100
                                            @elseif($diameter == '90') bg-orange-100
                                            @else bg-red-100
                                            @endif">
                                    <i class="fas text-xl
                                                @if($diameter == '63') fa-circle text-blue-600
                                                @elseif($diameter == '90') fa-dot-circle text-orange-600
                                                @else fa-bullseye text-red-600
                                                @endif"></i>
                                </div>
                                <div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-3">
                                ...
                                <p class="text-lg font-bold 
                                            @if($diameter == '63') text-blue-600
                                            @elseif($diameter == '90') text-orange-600
                                            @else text-red-600
                                            @endif">{{ number_format($progressPercent, 1) }}%</p>
                            </div>
                        </div>
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-3">
                            <div class="h-2 rounded-full transition-all duration-300
                                        @if($diameter == '63') bg-blue-500
                                        @elseif($diameter == '90') bg-orange-500
                                        @else bg-red-500
                                        @endif" style="width: {{ min(100, $progressPercent) }}%"></div>
                        </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">{{ $lowering->nama_jalan }} -
                                                {{ $lowering->penggelaran }}m
                                            </p>
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">{{ $line->cluster->nama_cluster }} -
                                            Ø{{ $line->diameter }}mm
                                        </p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm text-gray-600">{{ $line->total_penggelaran }}m /
                                            {{ $line->estimasi_panjang }}m
                                        </p>
                                        <span class="inline-flex px-2 py-1 text-xs rounded-full
