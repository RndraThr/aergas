...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('jalur.lowering.import.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md flex items-center">
    ...
    @else
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-green-700 text-sm mt-1">
                        {{ $results['success'] }} baris siap untuk diimport. Klik tombol "Lanjutkan Import" untuk melanjutkan.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-4">
            <form action="{{ route('jalur.lowering.import.execute') }}" method="POST" enctype="multipart/form-data" class="flex-1">
                @csrf
                ...
                <button type="submit"
                    ...
                    Lanjutkan Import ({{ $results['success'] }} Data)
                </button>
            </form>
