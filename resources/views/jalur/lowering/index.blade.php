...
<div class="container mx-auto px-6 py-8" x-data="jalurLoweringPageData()" x-init="restorePageState()">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-3">
            <a href="{{ route('jalur.mc0.import.index') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"></path>
                </svg>
                Import MC-0
            </a>
            <a href="{{ route('jalur.lowering.import.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow mb-6 p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Jenis Perkerasan</label>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div>
                                    ...
                                    @if($lowering->tipe_material)
                                        <div class="text-xs text-gray-400">Perkerasan: {{ $lowering->tipe_material }}</div>
                                    @endif
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
