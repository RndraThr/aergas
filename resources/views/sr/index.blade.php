            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-4 py-3">
                <div class="flex items-center gap-2">
                  ...
                  <template x-if="row.rejected_photos_count > 0">
                    <div class="relative">
                      <button class="text-red-600 hover:text-red-800 text-xs flex items-center gap-1" :data-sr-id="row.id"
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex justify-end gap-1">
                  <a :href="`/sr/${row.id}`" @click="savePageState()"
                  ...
                  <template x-if="canEdit(row)">
                    <a :href="`/sr/${row.id}/edit`" @click="savePageState()"
                      class="px-3 py-1.5 text-xs bg-blue-100 text-blue-700 rounded hover:bg-blue-200" title="Edit SR">
                      <i class="fas fa-edit mr-1"></i>Edit
                    </a>
                  </template>
                  <template x-if="canEdit(row)">
                    <button @click="confirmDelete(row.id, row.reff_id_pelanggan)"
                      class="px-3 py-1.5 text-xs bg-red-100 text-red-700 rounded hover:bg-red-200" title="Hapus SR">
