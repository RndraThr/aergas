    ...
    <form class="bg-white rounded-xl card-shadow p-6 space-y-8" @submit.prevent="onSubmit">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-red-700 text-sm mt-1">Customer ini memiliki status "batal" dan tidak dapat melanjutkan
                      ke modul SR. Silakan hubungi admin untuk informasi lebih lanjut.</p>
                  </div>
                </div>
              </div>
            </template>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Pemasangan <span
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">No Seri MGRT <span
                class="text-red-500">*</span></label>
        ...
        async onSubmit() {
          ...
          try {
            ...
            if (!response.ok || !result.success) {
              let msg = result.message || 'Gagal menyimpan SR';
              if (result.errors) {
