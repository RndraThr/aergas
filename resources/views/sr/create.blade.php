...
@php
  ...
  if (empty($photoDefs)) {
      $photoDefs = [
          ['field'=>'pneumatic_start','label'=>'Foto Pneumatic START SR','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'pneumatic_finish','label'=>'Foto Pneumatic FINISH SR','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'jenis_tapping','label'=>'Foto Jenis Tapping','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'kedalaman','label'=>'Foto Kedalaman','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'mgrt','label'=>'Foto MGRT','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'pondasi','label'=>'Foto Pondasi','accept'=>['image/*'],'required_objects'=>[]],
          ['field'=>'isometrik_scan','label'=>'Scan Isometrik SR (TTD lengkap)','accept'=>['image/*','application/pdf'],'required_objects'=>[]],
      ];
  }
...
function srCreate() {
  return {
    ...
    async uploadAllPhotos(srId) {
        const urlTpl = @json(route('sr.photos.upload', ['sr' => '__ID__']));
