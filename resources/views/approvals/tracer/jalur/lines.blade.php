                ...
                <div class="p-6">
                    ...
                    <div x-show="filters.search || filters.filter !== 'all' || filters.date_from || filters.date_to" class="mt-4 pt-4 border-t border-gray-200">
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span x-show="filters.date_from" class="inline-flex items-center gap-1 px-2.5 py-1 bg-indigo-100 text-indigo-700 rounded-md text-xs font-medium">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span x-show="filters.date_to" class="inline-flex items-center gap-1 px-2.5 py-1 bg-indigo-100 text-indigo-700 rounded-md text-xs font-medium">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                </svg>
                ...
                <div class="h-full">
                    ...
                    <template x-if="item.item_type === 'line'">
                        <div class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col h-full">
                            <a :href="`/approvals/tracer/jalur/lines/${item.id}/evidence`" class="flex flex-col flex-1 h-full">
                                {{-- Card Header - Compact --}}
                            ...
                            <div class="mb-3 p-3 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-semibold text-gray-900" x-text="item.nama_jalan && item.nama_jalan.trim() !== '' ? item.nama_jalan : '-'"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <template x-if="item.item_type === 'joint'">
                        <div class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-2 border-blue-200 overflow-hidden flex flex-col h-full">
                            <a :href="`/approvals/tracer/jalur/joints/${item.id}/evidence`" class="flex flex-col flex-1 h-full">
                                {{-- Card Header - Compact --}}
