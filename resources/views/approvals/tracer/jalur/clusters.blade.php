...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50" x-data="clustersData()" x-init="init()">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <template x-for="cluster in clusters" :key="cluster.id">
                <div class="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden transform hover:-translate-y-1 flex flex-col">
                    <a :href="`{{ route('approvals.tracer.jalur.clusters') }}/${cluster.id}/lines`" class="flex flex-col flex-1">
                        {{-- Card Header --}}
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            ...
                            <div x-show="cluster.approval_stats.rejected_photos > 0" class="p-3 bg-red-50 border border-red-200 rounded-lg">
