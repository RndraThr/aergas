...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50" x-data="clustersData()"
        x-init="init()">
        <div class="container-fluid px-4 py-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-1">
                                        Tracer Approval - Jalur Lowering Management
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                        ...
                        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 border border-orange-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    <div class="text-sm font-medium text-orange-600 mb-1">Pending Photos</div>
                                    <div class="text-3xl font-bold text-orange-900" x-text="stats.pending_photos"></div>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4 border border-red-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    <div class="text-sm font-medium text-red-600 mb-1">Rejected Photos</div>
                                    <div class="text-3xl font-bold text-red-900" x-text="stats.rejected_photos"></div>
                                </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" x-model="filters.search" @input.debounce.500ms="fetchClusters(true)"
                        ...
                        <div class="w-full md:w-56">
                            <select x-model="filters.filter" @change="fetchClusters(true)"
                        ...
                        <div class="flex gap-2">
                            <button @click="resetFilters()" x-show="filters.search || filters.filter !== 'all'"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <template x-for="cluster in clusters" :key="cluster.id">
                    <div
                        class="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden transform hover:-translate-y-1 flex flex-col">
                        <a :href="`{{ route('approvals.tracer.jalur.clusters') }}/${cluster.id}/lines`"
                            ...
                            <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-5 border-b border-gray-200">
                                <div class="flex items-start justify-between">
                                        ...
                                        <div class="flex items-center gap-3 mb-2">
                                            ...
                                            <div>
                                                <h3 class="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition"
                                                    x-text="cluster.nama_cluster"></h3>
                                                <span
                                                    class="inline-block mt-1 px-3 py-1 text-xs font-semibold rounded-full bg-gray-200 text-gray-700"
                                                    x-text="cluster.code_cluster"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <span x-show="cluster.approval_stats.pending_photos > 0"
                                            class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold rounded-full bg-orange-100 text-orange-800 border border-orange-200">
                                        ...
                                        <span
                                            x-show="cluster.approval_stats.pending_photos === 0 && cluster.approval_stats.rejected_photos > 0"
                                            class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold rounded-full bg-red-100 text-red-800 border border-red-200">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                        ...
                                        <span x-show="cluster.approval_stats.total_photos === 0"
                                            class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold rounded-full bg-gray-100 text-gray-600 border border-gray-200">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                        ...
                                        <span
                                            x-show="cluster.approval_stats.pending_photos === 0 && cluster.approval_stats.rejected_photos === 0 && cluster.approval_stats.total_photos > 0"
                                            class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold rounded-full bg-green-100 text-green-800 border border-green-200">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div class="bg-blue-50 rounded-lg p-4 border border-blue-100">
                                        ...
                                        <div class="text-2xl font-bold text-blue-900"
                                            x-text="cluster.approval_stats.total_items || (cluster.approval_stats.total_lines + (cluster.approval_stats.total_joints || 0))">
                                        </div>
                                    </div>
                                    <div class="bg-orange-50 rounded-lg p-4 border border-orange-100">
                                        <div class="text-xs font-medium text-orange-600 mb-1">Pending Photos</div>
                                        <div class="text-2xl font-bold text-orange-900"
                                            x-text="cluster.approval_stats.pending_photos"></div>
                                    </div>
                                    <div class="bg-green-50 rounded-lg p-4 border border-green-100">
                                        <div class="text-xs font-medium text-green-600 mb-1">Approved Photos</div>
                                        <div class="text-2xl font-bold text-green-900"
                                            x-text="cluster.approval_stats.approved_photos"></div>
                                    </div>
                                    <div class="bg-red-50 rounded-lg p-4 border border-red-100">
                                        <div class="text-xs font-medium text-red-600 mb-1">Rejected Photos</div>
                                        <div class="text-2xl font-bold text-red-900"
                                            x-text="cluster.approval_stats.rejected_photos"></div>
                                    </div>
                                </div>
                ...
                <div x-show="clusters.length === 0" class="col-span-2">
                    <div class="bg-white rounded-2xl shadow-md p-16 text-center border border-gray-100">
                        ...
                        <p class="text-gray-500 text-lg">
                            <span x-show="filters.search">Tidak ditemukan cluster dengan kata kunci "<span
                                    x-text="filters.search"></span>"</span>
                            <span x-show="!filters.search && filters.filter !== 'all'">Tidak ada cluster dengan filter yang
                                dipilih</span>
                            <span x-show="!filters.search && filters.filter === 'all'">Belum ada cluster yang terdaftar
                                dalam sistem</span>
                        </p>
                    </div>
                </div>
                ...
                return {
                    ...
                    async fetchClusters(resetPage = false) {
                        ...
                        try {
                            ...
                            const response = await fetch(`{{ route('approvals.tracer.jalur.clusters') }}?${params}`, {
                                headers: {
