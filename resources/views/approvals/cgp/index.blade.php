...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Final approval untuk foto dari SK, SR, Gas In, dan Jalur yang sudah di-review Tracer</p>
        </div>
        <div class="flex space-x-3">
            ...
            <a href="{{ route('approvals.cgp.jalur-photos') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-medium">
                🔧 Review Foto Jalur
            </a>
        </div>
    </div>
