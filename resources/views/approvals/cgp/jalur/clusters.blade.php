...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50" x-data="clustersData()"
        x-init="init()">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <template x-for="cluster in clusters" :key="cluster.id">
                    <div
                        ...
                        <a :href="`{{ route('approvals.cgp.jalur.clusters') }}/${cluster.id}/lines`"
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <span x-show="cluster.approval_stats.total_photos === 0"
                                            ...
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                                    d="M10 18a8 8 0 000-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                            No Evidence
                                        </span>
