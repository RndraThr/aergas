        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <template x-for="line in lines" :key="line.id">
                <div class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col">
                    <a :href="`/approvals/cgp/jalur/lines/${line.id}/evidence`" class="flex flex-col flex-1">
                        {{-- Card Header - Compact --}}
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <template x-if="line.approval_stats.rejections && line.approval_stats.rejections.has_rejections">
                                <div class="mb-3 space-y-1">
                                    <template x-for="rejection in line.approval_stats.rejections.all" :key="rejection.field_name">
