...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50" x-data="linesData()"
        x-init="init()">
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 flex-1">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center shadow-lg">
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                            <div class="bg-gradient-to-br from-orange-50 to-orange-100 p-4 flex-1">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-2xl font-bold text-orange-900" x-text="stats.pending_photos || 0">
                                        </div>
                                    </div>
                                    <div
                                        class="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center shadow-lg">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="bg-orange-50/50 px-4 py-2 border-t border-orange-100">
                                <div class="text-xs flex justify-between text-orange-800 font-medium">
                                    ...
                                    <span>Joint: <strong
                                            x-text="stats.breakdown?.pending_photos?.joint || 0"></strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                            <div class="bg-gradient-to-br from-green-50 to-green-100 p-4 flex-1">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-2xl font-bold text-green-900" x-text="stats.approved_photos || 0">
                                        </div>
                                    </div>
                                    <div
                                        class="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center shadow-lg">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="bg-green-50/50 px-4 py-2 border-t border-green-100">
                                <div class="text-xs flex justify-between text-green-800 font-medium">
                                    <span>Line: <strong
                                            x-text="stats.breakdown?.approved_photos?.line || 0"></strong></span>
                                    <span>Joint: <strong
                                            x-text="stats.breakdown?.approved_photos?.joint || 0"></strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                            <div class="bg-gradient-to-br from-red-50 to-red-100 p-4 flex-1">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-2xl font-bold text-red-900" x-text="stats.rejected_photos || 0">
                                        </div>
                                    </div>
                            ...
                            <div class="bg-red-50/50 px-4 py-2 border-t border-red-100">
                                <div class="text-xs flex justify-between text-red-800 font-medium">
                                    <span>Line: <strong
                                            x-text="stats.breakdown?.rejected_photos?.line || 0"></strong></span>
                                    <span>Joint: <strong
                                            x-text="stats.breakdown?.rejected_photos?.joint || 0"></strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div x-show="filters.search || filters.filter !== 'all' || filters.date_from || filters.date_to"
                            ...
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                <span x-show="filters.date_from"
                                    class="inline-flex items-center gap-1 px-2.5 py-1 bg-green-100 text-green-700 rounded-md text-xs font-medium">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="h-full">
                        ...
                        <template x-if="item.item_type === 'line'">
                            <div
                                ...
                                <a :href="`/approvals/cgp/jalur/lines/${item.id}/evidence`"
                                    ...
                                    <div class="p-4 flex-1 flex flex-col">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <template
                                                x-if="!line.approval_stats.total_photos || line.approval_stats.total_photos === 0">
                        ...
                        <template x-if="item.item_type === 'joint'">
                            <div
                                ...
                                <a :href="`/approvals/cgp/jalur/joints/${item.id}/evidence`"
                                    class="flex flex-col flex-1 h-full">
                                    {{-- Card Header - Compact --}}
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span
                                                x-show="!item.approval_stats.status || item.approval_stats.status === 'no_evidence'"
                                                class="px-3 py-1 text-xs font-bold rounded-full bg-gray-100 text-gray-600">
                                                No Data
                                            </span>
                                        </div>
                ...
                <div x-show="items.length === 0" class="col-span-2">
                    <div class="bg-white rounded-xl shadow-md p-12 text-center border border-gray-100">
                        ...
                        <p class="text-gray-500">
                            <span x-show="filters.search">Tidak ditemukan line atau joint dengan kata kunci "<span
                                    x-text="filters.search"></span>"</span>
                            <span x-show="!filters.search && filters.filter !== 'all'">Tidak ada item dengan filter yang
                                dipilih</span>
                            <span x-show="!filters.search && filters.filter === 'all'">Belum ada line atau joint dalam
                                cluster ini</span>
                        </p>
                    </div>
                </div>
