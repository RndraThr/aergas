...
<div class="space-y-6" x-data="skCreate()" x-init="init()">
  ...
  <div class="flex items-center justify-between">
    ...
    <a href="javascript:void(0)" onclick="goBackWithPagination('{{ route('sk.index') }}')" class="px-4 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200">Kembali</a>
  </div>
  ...
  <form class="bg-white rounded-xl card-shadow p-6 space-y-8" @submit.prevent="onSubmit">
            ...
            <div class="bg-red-50 border border-red-200 p-4 rounded">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-red-700 text-sm mt-1">Customer ini memiliki status "batal" dan tidak dapat melanjutkan ke modul SK. Silakan hubungi admin untuk informasi lebih lanjut.</p>
                </div>
              </div>
            </div>
          </template>
    ...
    <div class="flex justify-end gap-3 pt-2">
      <a href="javascript:void(0)" onclick="goBackWithPagination('{{ route('sk.index') }}')" class="px-4 py-2 bg-gray-100 rounded hover:bg-gray-200">
