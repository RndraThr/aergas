...
@section('content')
  ...
  <div class="space-y-6" x-data="skShow()" x-init="init()">
        ...
        <div class="space-y-1">
          ...
          @if($sk->createdBy)
            <div class="flex items-center">
              <div
                class="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center mr-3 shadow">
        ...
        <div class="mt-6 pt-6 border-t border-green-200">
          <div class="flex items-center gap-4 flex-wrap">
            ...
            @if($sk->ai_overall_status)
              <div class="flex items-center">
                <div
                  class="w-3 h-3 rounded-full mr-2 {{ $sk->ai_overall_status === 'ready' ? 'bg-green-500' : 'bg-yellow-500' }}">
                </div>
          ...
          <div class="space-y-1">
            ...
            <div class="font-medium text-gray-700">
              @if($sk->calonPelanggan->no_telepon)
                <a href="tel:{{ $sk->calonPelanggan->no_telepon }}"
          ...
          <div class="space-y-1">
            ...
            <div class="font-medium text-gray-700">
              @if($sk->calonPelanggan->email)
                <a href="mailto:{{ $sk->calonPelanggan->email }}"
                  class="text-green-600 hover:text-green-800 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
      <div class="flex items-center gap-3 mb-6">
        <div
          class="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center shadow">
