...
<div id="successToast" class="fixed top-4 right-4 bg-green-600 text-white px-6 py-4 rounded-lg shadow-2xl transform translate-x-full transition-transform duration-300 z-50">
  <div class="flex items-center">
    ...
    <div>
      ...
      <p class="text-sm text-green-100" id="deleteDetails">SK telah dihapus dari sistem</p>
    </div>
  </div>
</div>
...
function showSuccessToast(result = {}) {
  ...
  let message = 'SK telah dihapus dari sistem';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('a[href*="/sk/"]').forEach(link => {
    if (link.href.includes('/sk/') && !link.href.includes('/create') && !link.href.includes('/edit')) {
