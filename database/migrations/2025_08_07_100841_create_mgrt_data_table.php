...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mgrt_data', function (Blueprint $table) {
            $table->id();
            $table->string('reff_id_pelanggan', 50);

            // MGRT Form Fields
            $table->string('no_seri_mgrt', 100);
            $table->string('merk_brand_mgrt', 100)->nullable();
            $table->string('foto_mgrt_url', 500)->nullable();
            $table->string('foto_pondasi_url', 500)->nullable();
